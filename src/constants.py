...
if MODE == "PROD":
    ETHEREUM_ADDRESS = config("ETHEREUM_ADDRESS_MAINNET")
    ETH_PRIVATE_KEY = ETH_PRIVATE_KEY_MAINNET
    HTTP_PROVIDER = config("HTTP_PROVIDER_MAINNET")
    ...
    ETHEREUM_ADDRESS = config("ETHEREUM_ADDRESS_TESTNET")
    ETH_PRIVATE_KEY = ETH_PRIVATE_KEY_TESTNET
    HTTP_PROVIDER = config("HTTP_PROVIDER_TESTNET")
